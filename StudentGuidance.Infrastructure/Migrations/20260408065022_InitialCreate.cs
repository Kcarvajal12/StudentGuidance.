        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CodigoEmpleado = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Citas_Orientadores_OrientadorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recomendaciones = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seguimientos_Citas_CitaId",
                        column: x => x.CitaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Citas_OrientadorId",
                table: "Citas",
                column: "OrientadorId");

            migrationBuilder.CreateIndex(
                name: "IX_Seguimientos_CitaId",
                table: "Seguimientos",
                column: "CitaId");
        }
